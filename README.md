...
- <img src="https://cdn.simpleicons.org/solana/9945FF" height="14"/> [SicariusGuard](https://github.com/Chronolapse411/sicarius-guard) - 7-layer Solana token safety oracle for AI agents. Performs byte-level SPL mint inspection, honeypot simulation via Jupiter DEX, holder concentration analysis, Birdeye market intelligence, and Helius wallet reputation scoring.
